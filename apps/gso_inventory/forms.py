...
class InventoryItemForm(forms.ModelForm):
    ...
    class Meta:
        model = InventoryItem
        fields = [
            'name', 'description', 'quantity', 'unit_of_measure',
            'reorder_level', 'arrival_date',
        ]
        widgets = {
...
class InventoryItemFormAllUnits(InventoryItemForm):
    ...
    class Meta(InventoryItemForm.Meta):
        fields = [
            'unit', 'name', 'description', 'quantity', 'unit_of_measure',
            'reorder_level', 'arrival_date',
        ]
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['unit'].label = 'Service Unit'
        self.fields['unit'].help_text = 'Choose the service unit (e.g., Electrical, Utility, Motorpool)'
